...
public class ReadBusStop {
    ...
    public void truncateBusStop() {
        String sql = "truncate table bus_stop cascade";
        try {
    ...
    private void insertBusStop(){
        ...
        try {
            ...
            String sql = "insert into bus_stop(exit_id, name) values (?, ?)";
            stmt = conn.prepareStatement(sql);
    ...
    public static void main(String[] args) {
        ReadBusStop rbs = new ReadBusStop();
        rbs.insertBusStop();
    }
}
